...
当前阶段：P2 微信真实登录、P3A 云存档 MVP 和 P3B V1 存档范围收缩已完成部署及微信冷启动验收；V1 云端只持久化 `user`，设置、引导、任务、活动和局内续玩继续保存在本地。P4A 断网恢复、P4B 强杀恢复和 P4C 旧 revision 冲突均已通过微信真实服务验收，仍待抖音环境联调。
